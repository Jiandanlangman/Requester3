...
class RequestEntity internal constructor(
    ...
    companion object {
        ...
        const val PROHIBIT_FLAG_GLOBAL_HEADERS = 4
        const val PROHIBIT_FLAG_GLOBAL_PARAMS = 8
        const val PROHIBIT_FLAG_ALL =
            PROHIBIT_FLAG_PROCESSOR or PROHIBIT_FLAG_RESPONSE_INTERCEPTOR or PROHIBIT_FLAG_GLOBAL_HEADERS or PROHIBIT_FLAG_GLOBAL_PARAMS
        const val PROHIBIT_FLAG_ALL_EXCLUDE_RESPONSE_INTERCEPTOR =
            PROHIBIT_FLAG_PROCESSOR or PROHIBIT_FLAG_GLOBAL_HEADERS or PROHIBIT_FLAG_GLOBAL_PARAMS
    }
